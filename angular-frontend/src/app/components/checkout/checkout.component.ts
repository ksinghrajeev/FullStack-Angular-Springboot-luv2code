...
export class CheckoutComponent implements OnInit {
  ...
  constructor(
    ...
    public luv2ShopFromService: Luv2ShopFormService,
  ...
  onSubmit() {
    ...
    if (this.checkoutFormGroup.invalid) {
      ...
      console.log(`this.checkoutFormGroup.markAllAsTouched(): ${this.checkoutFormGroup.markAllAsTouched()}`);
      return;
    }
  ...
  resetCart() {
    ...
    this.cartService.eraseLocalStorageCartItem();
